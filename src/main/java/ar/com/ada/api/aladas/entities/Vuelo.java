...
public class Vuelo {
    ...
    public EstadoVueloEnum getEstadoVueloId() {
        return EstadoVueloEnum.parse(this.estadoVueloId);
    }
    ...
    public enum EstadoVueloEnum {
        ...
        REPROGRAMADO(7), CANCELADO(8), CERRADO(9); // No creamos mas estados porque este sistema esta enfocado a un
                                                   // sistema de gestion de reservas, no al trafico aereo como tal.

...
class AladasApplicationTests {
	...
	void testearEncriptacion(){
		...
		//assertTrue(contraseñaImaginariaEncriptadaDesencriptada.equals(contraseñaImaginaria));	// se pueden usar cualquiera de estas opciones, pero 
		assertEquals(contraseñaImaginariaEncriptadaDesencriptada, contraseñaImaginaria);		//con esta se achican los assert
		...
		void testearContraseña(){
			...
			usuario.setUsername("dianadegales@gmail.com");
		}
